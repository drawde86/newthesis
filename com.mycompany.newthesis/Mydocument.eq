...
public class Mydocument: MobileApplicationScreenWidget
...
//Search
		...
		myform.add_text_field("Search", null,null , null, "Search");

	var block1_align = AlignWidget.instance();

	block1_align.set_margins(5,90,5,250);
	block1_align.add_align(0,0,myform);
	add(block1_align);
...
//		docs.insert("haha2",2);
//
//		var mytable = TableWidget.instance();
//		mytable.set_columns(4);
//		mytable.set_border_color(Color.instance("#000000"));
//		mytable.add_row(Collection.insert(docs));
//
//	
//
//
//		var mytable_align = AlignWidget.instance();
///
//	mytable_align.set_margins(5,90,5,200);
//	mytable_align.add_align(0,0,mytable);
//	add(mytable_align);
//
